...
test do
  ...
  it "install chart with release name" do
  ...
  it "install chart with namespace flag" do
  ...
  it "get values with output flag" do
  ...
  it "upgrade with install flag" do
  ...
  it "upgrade with values file" do
  ...
  it "install with multiple flags" do
  ...
  it "upgrade install with values and set" do
    result = tree.evaluate(Kube.helm {
  ...
  it "to_s produces valid command string" do
    result = tree.evaluate(Kube.helm { install.my_release.("bitnami/nginx").namespace("default").wait(true) })
    result.to_s.should == "install my_release bitnami/nginx --namespace default --wait"
  end
end
