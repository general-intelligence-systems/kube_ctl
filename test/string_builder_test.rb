...
class CommandTreeTest < Minitest::Test
  ...
  #   assert_string(result, "exec 123456-7890 date")
  # end
  ...
  #   assert_string(result, "exec 123456-7890 -c ruby-container date")
  # end
  ...
  #   assert_string(result, "exec 123456-7890 -c ruby-container -i -t -- bash -il")
  # end
  ...
  #   assert_string(result, "exec 123456-7890 -i -t -- ls -t /usr")
  # end
  ...
  #   assert_string(result, "get -o json pod web-pod-13je7")
  # end
  ...
  #   assert_string(result, "get -o template pod/web-pod-13je7 --template={{.status.phase}}")
  # end
  ...
  #   assert_string(result, "get rc/web service/frontend pods/web-pod-13je7")
  # end
  ...
  #   assert_string(result, "label pods foo bar-")
  # end
